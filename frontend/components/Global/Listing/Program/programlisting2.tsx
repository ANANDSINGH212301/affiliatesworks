...
const ProgramListing2 = ({ program }: ProgramListingProps) => {
            ...
            <div className="space-x-1">
              {program.countries?.nodes
                ...
                .map((country, index, array) => (
                  <React.Fragment key={index}>
                    <span className="text-[14px] tracking-wide font-normal hover:text-secondary">
                      {country.name}
                    </span>
                    {index < array.length - 1 && <span> | </span>}
                  </React.Fragment>
...
export default ProgramListing2;
